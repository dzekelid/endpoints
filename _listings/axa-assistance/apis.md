...
created: "2018-08-27"
modified: "2018-08-27"
url: https://raw.githubusercontent.com/streamdata-gallery-topics/endpoints/master/_listings/axa-assistance/apis.md
specificationVersion: "0.14"
apis:
- name: AXA Assistance - Requests the activation of a certificate either to cover
    an appliance purchased or to extend the warranty period of an appliance purchased.
    At least one product_criteria has to be specified to identify the product to which
    to subscribe. This endpoint
  x-api-slug: salesv1individualappliancecertificates-post
  ...
  - type: x-postman-collection
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/endpoints/master/_listings/axa-assistance/salesv1individualappliancecertificates-post-postman.md
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/endpoints/master/_listings/axa-assistance/salesv1individualappliancecertificates-post-openapi.md
- name: AXA Assistance - Requests the activation of a certificate either to cover
    an appliance purchased or to extend the warranty period of an appliance purchased.
    At least one product_criteria has to be specified to identify the product to which
    to subscribe. This endpoint
